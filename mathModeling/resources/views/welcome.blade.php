...
<head>
    ...
    <link rel="icon" href="/mathModeling/public/img/favicon.png" type="image/png">
    <!-- CSRF Token -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav justify-content-center">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">Видео</a>
                        <li class="nav-item submenu dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                               aria-expanded="false">О нас</a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="#">проекты</a>
                            </ul>
                        </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7" style="padding-bottom: 60px;">
                    <div class="banner_content" id="consult-form-wrapper">
                        <h2>
        ...
        <div class="row about_content align-items-center">
            <div class="col-lg-6">
                <div class="section_content">
                    ...
                    <p>Мы специализируемся по расчетам на прочность - статическую, динамическую. Решаем задачи газодинамики и термодинамики!
                        Владеем основами расчетов на устойчивость и классом нелинейных задач (контактные и пластические НДС). </p>
                    <a class="primary_btn" href="#">Узнай больше</a>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row text-center">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="new_games_item">
                    <img src="/mathModeling/public/img/b_map1.png" alt="">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="new_games_item">
                    <img src="/mathModeling/public/img/b_map2.png" alt="">
                    <div class="upcoming_title">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="new_games_item">
                    <img src="/mathModeling/public/img/b_map3.png" alt="">
                    <div class="upcoming_title">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="new_games_item">
                    <img src="/mathModeling/public/img/b_map4.png" alt="">
                    <div class="upcoming_title">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="row recent_update_text">
                        <div class="col-lg-6">
                            <div class="chart_img">
                                <img class="img-fluid" src="/mathModeling/public/img/recent_up.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="section_content">
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-gallery">
                            ...
                            <img class="img-fluid w-100" src="/mathModeling/public/img/gallery_img1.png" alt="">
                            <div class="content">
                                <a class="pop-up-image" href="/mathModeling/public/img/gallery_img1.png">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-gallery">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="/mathModeling/public/img/gallery_img2.png" alt="">
                            <div class="content">
                                <a class="pop-up-image" href="/mathModeling/public/img/gallery_img2.png">
                                    <i class="lnr lnr-eye"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="single-gallery">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="/mathModeling/public/img/gallery_img3.png" alt="">
                            <div class="content">
                                <a class="pop-up-image" href="/mathModeling/public/img/gallery_img3.png">
                                    <i class="lnr lnr-eye"></i>
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 hidden-md hidden-sm">
                <div class="single-gallery">
                    <div class="overlay"></div>
                    <img class="img-fluid w-100" src="/mathModeling/public/img/gallery_img4.png" alt="">
                    <div class="content">
                        <a class="pop-up-image" href="/mathModeling/public/img/gallery_img4.png">
                            <i class="lnr lnr-eye"></i>
                        </a>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="testi_slider owl-carousel">
            <div class="testi_item">
                <img src="/mathModeling/public/img/quote.png" alt="">
                <h4>Fanny Spencer</h4>
                <ul class="list">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="blog_items">
                    <div class="blog_img_box">
                        <img class="img-fluid" src="/mathModeling/public/img/blog_img1.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog_items">
                    <div class="blog_img_box">
                        <img class="img-fluid" src="/mathModeling/public/img/blog_img2.png" alt="">
                    </div>
                    <div class="blog_content">
                        <a class="title" href="blog.html">Portable Fashion for women</a>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
            ...
            <div class="col-lg-4 hidden-md">
                <div class="blog_items">
                    <div class="blog_img_box">
                        <img class="img-fluid" src="/mathModeling/public/img/blog_img3.png" alt="">
                    </div>
                    <div class="blog_content">
                        <a class="title" href="blog.html">Portable Fashion for women</a>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
